...
protected:
    ...
    int Buffs;
public:
    LegendarArmor (LegyArmor la1, int RuneSlots1, int Buffs1, int MagicDurability1, Protection p1, int Durability1, int Rarity1): Armor (Protection p1, Durability1, Rarity1) {}
